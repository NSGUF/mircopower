...
import Projects from './component/donationProjects'
...
export default class Better extends React.Component {
    ...
    componentDidMount() {
        ...
        Http.post("http://localhost:8080/MicroPower/ShowServlet", {flag: "donation"}, this.callBackFun.bind(this), this.error);
    }
