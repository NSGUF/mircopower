...
export default class AddReceive extends React.Component {
    ...
    handleClick(e) {
        e.preventDefault()
        this.props.history.push("/my/receive")
    }
    ...
    render() {
        ...
        return (
            <div className="item-setting">
                <h2 className="text-center">添加新地址</h2>
                <div className="container">
                    <form className="publishForm add-receive-form">
                        <div className="form-container">
                            <div className="form-group form-group-lg add-receive-item">
                                <label htmlFor="" className="col-md-1 control-label">收件人</label>
                                <div className="col-md-9">
                                    <input type="text" className="form-control text_validata"
                                           placeholder="输入收件人姓名" onChange={this.handleChange.bind(this, "name")}/>
                                </div>
                            </div>
                            <div className="form-group form-group-lg add-receive-item">
                                <label htmlFor="" className="col-md-1 control-label">手机号码</label>
                                <div className="col-md-9">
                                    <input type="text" className="form-control text_validata"
                                           placeholder="输入手机号码" onChange={this.handleChange.bind(this, "cellphone")}/>
                                </div>
                            </div>
                            <div className="form-group form-group-lg add-receive-item ">
                                <label htmlFor="" className="col-md-1 control-label">所在地区</label>
                                <div className="col-md-9">
                            ...
                            <div className="form-group form-group-lg add-receive-item">
                                <label htmlFor="" className="col-md-1 control-label">详细地址</label>
                                <div className="col-md-9">
                                <textarea cols="66" rows="5" placeholder="填写详细地址，例如街道名称，门牌号码，楼层和房间号等信息。"
                                          onChange={this.handleChange.bind(this, "detail")}></textarea>
                                </div>
                            </div>
                            <div className="form-group form-group-lg add-receive-item">
                                <div className="col-md-12 text-center form-btn">
                                    <div className="left-btn">
                                        <input type="submit" className="button-green" value="保存"
                                               onClick={this.handleSubmit.bind(this)}/>
                                    </div>
                                    <div className="right-btn">
                                        <Link to="/my/receive">
                                            <input type="button" value="返回" className="button-green"
