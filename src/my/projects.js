...
export default class Setting extends React.Component {
    ...
    componentDidMount() {
        Http.post("http://localhost:8080/MicroPower/MyProjectsServlet", {flag: "help"}, this.callBackHelp.bind(this), this.error);
    }
    ...
    callBackHelp(result) {
        ...
        Http.post("http://localhost:8080/MicroPower/MyProjectsServlet", {flag: "donation"}, this.callBackDonation.bind(this), this.error);
    }
    ...
    callBackDonation(result) {
        ...
        Http.post("http://localhost:8080/MicroPower/MyProjectsServlet", {flag: "share"}, this.callBackShare.bind(this), this.error);
    }
