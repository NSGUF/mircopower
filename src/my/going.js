...
export default class Setting extends React.Component {
    ...
    callBackLogin(result) {
        if (result.flag === false) {
            ...
            Http.post(Http.URL+"/MicroPower/MyGoing", {flag: "help"}, this.callBackHelp.bind(this), this.error);
        }
    }
    ...
    callBackHelp(result) {
        ...
        Http.post(Http.URL+"/MicroPower/MyGoing", {flag: "donation"}, this.callBackDonation.bind(this), this.error);
    }
    ...
    callBackDonation(result) {
        ...
        Http.post(Http.URL+"/MicroPower/MyGoing", {flag: "share"}, this.callBackShare.bind(this), this.error);
    }
