...
const Terms = () => (
    <div className="foot-banner">
        <div className="container">
            <h2 className="text-center foot-h2">使用条款</h2>
            <div className="terms">
                <p>一、轻松筹服务简介与用户要求</p>
                <p>
                    <br/>
                ...
                <p>
                    4、您应该按照本协议约定行使权利并履行义务。如您不能接受本协议的约定，包括但不限于不能接受修订后的协议及各类规则，则您应立即停止使用轻松筹针对项目发起人提供的服务。如您继续使用轻松筹针对项目发起人提供的服务，则表示您同意并接受本协议及各类规则的约束。</p>
                <p>
                    <br/>
                </p>
                <p>三、项目发起人的资格</p>
                ...
                <p>
                    6、轻松筹应在有限合伙企业（有限责任公司）取得工商行政管理机关发放的营业执照之日起10日内将投资款汇入有限合伙企业（有限责任公司）所开设的银行账户中，有限合伙企业不成立或经投资者决议过半数不同意继续投资具体的创业项目的，应将投资款原额返还给投资人注册用户。</p>
                ...
                <p>
                    用户对网络服务的使用承担风险。轻松筹对此不作任何类型的担保，无论明确或隐含的。但轻松筹不对商业性的隐含担保、特定目的和不违反规定的适当担保作限制。轻松筹无法保障自身服务内容满足用户的要求，也无法担保服务不会中断，对服务的及时性，安全性均不作保证。轻松筹对在轻松筹上得到的任何信息服务或交易进程均不作担保。</p>
                <p>
                    <br/>
                </p>
                <p>七、轻松筹责任豁免</p>
                ...
                <p>
                    1、轻松筹对任何直接、间接、偶然、特殊及继起的损害不负责任，这些损害可能来自：不正当使用网络服务，在网上购买商品或进行同类型服务，在网上进行交易，非法使用网络服务或用户传送的信息有所变动。这些行为都有可能会导致轻松筹的形象受损，所以轻松筹事先提出这种损害的可能性。用户同意该等责任均由其自行承担（包括但不限于疏忽责任）。</p>
                <p>
                    2、为了网站的正常运行，轻松筹需要定期或不定期地对网站进行停机维护，因此类情况造成的正常服务中断，请用户理解，轻松筹将尽力避免服务中断或无法正常使用，导致用户在轻松筹交易无法完成或丢失有关信息、记录等，轻松筹不承担责任，但是轻松筹会尽合理的可能协助处理善后事宜，并努力使用户免受经济损失。</p>
                <p>
                    <br/>
                </p>
                <p>八、协议终止</p>
